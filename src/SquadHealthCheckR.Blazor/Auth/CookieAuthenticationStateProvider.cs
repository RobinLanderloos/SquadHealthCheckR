...
public class CookieAuthenticationStateProvider : AuthenticationStateProvider, IAccountManagement
{
    ...
    public override async Task<AuthenticationState> GetAuthenticationStateAsync()
    {
        ...
        try
        {
            ...
            UserInfo? userInfo = JsonSerializer.Deserialize<UserInfo>(userJson, _jsonSerializerOptions);
            ...
            if (userInfo != null)
            {
                ...
                claims.AddRange(
                    userInfo.Claims.Where(c => c.Key != ClaimTypes.Name && c.Key != ClaimTypes.Email)
                        .Select(c => new Claim((string)c.Key, c.Value)));
                ...
                RoleClaim[]? roles = JsonSerializer.Deserialize<RoleClaim[]>(rolesJson, _jsonSerializerOptions);
